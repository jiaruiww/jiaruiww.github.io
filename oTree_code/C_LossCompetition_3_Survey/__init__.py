...
def get_quiz_data_for_player(player):
    ...
    if quiz_results:
        ...
        print(f"A3_LT Survey - Player {player.id_in_group} data from competition_results:")
        ...
        print(f"A3_LT Survey - Player {player.id_in_group} data from direct participant.vars:")
...
class Player(BasePlayer):
    ...
    app3_completed = models.BooleanField(default=False, doc="Completed A3_LT_3_Survey")
